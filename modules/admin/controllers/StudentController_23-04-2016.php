...
class StudentController extends Controller
{
			...
			if($model->email != ''){
				Yii::$app->mailer->compose()
                        ...
                        if($model->mobile_no != ''){
                            ...
                            $username = 'rajpurams@gmail.com';
                            $hash = '0070a11e7a7204a6c4b0fceb9ad22167e12feb36';
                
                            $numbers = $model->mobile_no;
                            $sender = urlencode('TXTLCL');
                            $message = rawurlencode('Jamiah : You are selected.');
    ...
    public function actionExport()
    {
        ...
        $output .= '"Sr.No","Name","City","District","State","Date of Birth","Mobile No.","Landline No.","Registration Date","Email","Parent Mobile No.","Division","Sub Class","Class"';
        ...
        foreach($students as $val)
        {
            ...
            $output .='"'.$i.'","'.$name.'","'.$val->city.'","'.$val->district.'","'.$state.'","'.date('d M Y', $val->dob).'","'.$val->mobile_no.'","'.$val->landline_no.'","'.date('d M Y', $val->i_date).'","'.$val->email.'","'.$val->parent_mobile.'","'.$divisionName.'","'.$subclassName.'","'.$className.'"';
