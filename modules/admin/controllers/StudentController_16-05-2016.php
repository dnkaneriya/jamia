...
class StudentController extends Controller
{
    ...
    /*public function actionSelected()
    {
		...
		foreach($strvalues as $value){
            ...
            if($model->mobile_no != ''){
                ...
                //$username = 'memonjoyeb@gmail.com';
                //$hash = 'c46916f4520a5f0b0a578300723a65e5e7d739e4';

                $username = 'memonjoyeb@rocketmail.com';
                $hash = 'd6b10bce3c8bc93a40870ce5bbdbef0a45a99d44';
    ...
    public function actionAllocategr()
    {
        ...
        //die;
		$msg = 'Allocate GR No. to students successfully!!';
		$flash_msg = \Yii::$app->params['msg_success'].$msg.\Yii::$app->params['msg_end'];
		\Yii::$app->getSession()->setFlash('flash_msg', $flash_msg);
        $this->redirect(['index']);
    }
