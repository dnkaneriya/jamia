...
use app\models\ImpcontactSearch;
...
/**
 * ImpcontactController implements the CRUD actions for Impcontact model.
 */
class ImpcontactController extends Controller
{
    ...
    /**
     * Lists all Impcontact models.
     * @return mixed
     */
    public function actionIndex()
    {
        if(Yii::$app->user->can('important_contact_no')) {
            $searchModel = new ImpcontactSearch();
    ...
    /**
     * Displays a single Impcontact model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Impcontact model.
    ...
    /**
     * Updates an existing Impcontact model.
    ...
    /**
     * Deletes an existing Impcontact model.
    ...
    public function actionChange()
    {
        ...
        if($str!= null)
        {
            ...
            if(Impcontact::updateAll($cond,'id IN('.$str.')'))
            {
    ...
    /**
     * Finds the Impcontact model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Impcontact the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Impcontact::findOne($id)) !== null) {
            return $model;
        } else {
