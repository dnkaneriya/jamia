...
//        print_r($dataProvider);exit;
        ...
        return $this->render('closed-students', [
            ...
            'tajwidClassList' => $tajwidClassList,
            'standardList' => $standardList,
            'title' => 'Closed Students'
        ]);
    }
    
    public function actionHafizStudents()
    {
        $searchModel = new StudentSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->where(['hafiz_student' => 1]);
...
//        print_r($dataProvider);exit;
        ...
        return $this->render('closed-students', [
            ...
            'tajwidClassList' => $tajwidClassList,
            'standardList' => $standardList,
            'title' => 'Hafiz Students'
        ]);
    }
    
    public function actionAalimStudents()
    {
        $searchModel = new StudentSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->where(['aalim_student' => 1]);
