    ...
    <div class="col-lg-12">               
        ...
        <div class="box-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <?=
                    $form->field($model, 't_year')->dropDownList(
                            $yearList, [
                        'prompt' => 'Select Year',
                            ]
                    )
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <?=
                    $form->field($model, 't_month')->dropDownList(
                            $monthList, [
                        'prompt' => 'Select Month',
                            ]
                    )
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    ...
                    $form->field($model, 'class_id')->dropDownList(
                        ...
                        'prompt' => 'Select Class',
                        'onchange' => '
                                    $( "select#weightheight-subclass_id" ).html("showLoading");
                                    $.post( "admin/weightheight/get-subclass-list?id=' . '"+$(this).val(), 
                                    function(data) {

                                            $( "select#weightheight-subclass_id" ).html(data);
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    ...
                    $form->field($model, 'subclass_id')->dropDownList(
                        ...
                        'onchange' => '
                                $( "select#weightheight-division_id" ).html("showLoading");
                                $.post( "admin/weightheight/get-division-list?class_id=' . '"+$("#weightheight-class_id").val()+"&subclass_id="+$(this).val(), 
                                function(data) {
                                        $( "select#weightheight-division_id" ).html(data);
                                });',
