        ...
        <div class="box">
            ...
            <div class="row p-a">
                ...
                <div class="col-sm-3 text-right">
                    <a href="<?= Yii::$app->request->baseurl ?>/admin/tajwid-class-upgrade/create" id="job-export" class="btn btn-fw primary" title="Create a class"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function($model) {
                            $class = TajwidClass::findOne(['id' => $model->class_id]);
                            return isset($class->class_name) ? $class->class_name : '-';
                        }
                    ], 
                    [
                        'width' => '20%',
                        'attribute' => 'upgrade_class_id',
                        'vAlign' => 'middle',
                        'class' => '\kartik\grid\DataColumn',
                        'headerOptions' => ['style' => 'text-align:center'],
                        'pageSummary' => false,
                        ...
                        'filter' => $tajwidClass,
                        'value' => function($model) {
                            $class = TajwidClass::findOne(['id' => $model->upgrade_class_id]);
                            return isset($class->class_name) ? $class->class_name : '-';
                        }
                    ],
                    [
                        ...
                        'buttons' => [
                            ...
                            if ($action === 'view') {
                                $url = Yii::$app->request->baseUrl . '/admin/tajwid-class-upgrade/view?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'update') {
                                $url = Yii::$app->request->baseUrl . '/admin/tajwid-class-upgrade/update?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'delete') {
