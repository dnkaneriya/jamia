...
$model->decision_date = date('d-m-Y',$model->decision_date);
?>
    ...
    <div class="col-lg-12">
		<!--<section class="panel">-->
            <div class="box-header">
				<?php
					if($model->isNewRecord) {
						echo '<h3>'.Yii::t('app', 'Add Decision').'</h3>';
					}else{
						echo '<h3>'.Yii::t('app', 'Edit Decision').'</h3>';
					}
				?>
            </div>
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'decision_date')->textInput(['maxlength' => 255,'id'=>'decision_date']); ?>
                <?= $form->field($model, 'content')->textArea(['rows' => 10, 'ui-jp'=>'summernote']); ?>
