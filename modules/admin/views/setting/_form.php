    ...
    <div class="col-lg-12">
		<!--<section class="panel">-->
            <div class="box-header">
				<?php
					if($model->isNewRecord) {
						echo '<h3>'.Yii::t('app', 'Add Setting').'</h3>';
					}else{
						echo '<h3>'.Yii::t('app', 'Edit Setting').'</h3>';
					}
				?>
            </div>
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'setting_key')->textInput(['maxlength' => true, 'placeholder' => 'Setting Name']) ?>
