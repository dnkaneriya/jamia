            ...
            <div class="box-header">
				<?php
					if($model->isNewRecord) {
						echo '<h3>'.Yii::t('app', 'Add Division').'</h3>';
					}else{
						echo '<h3>'.Yii::t('app', 'Edit Division').'</h3>';
					}
				?>
            </div>
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'class_id')->dropDownList($classList, 
                	[
                		'prompt' => '-Select Class',
                		'onchange' => '
                                    $( "select#division-subclass_id" ).html("showLoading");
                                    $.post( "get-subclass-list?id='.'"+$(this).val(), 
                                    function(data) {
                                            $( "select#division-subclass_id" ).html(data);
                                    });'
            		]); ?>
                ...
                <?= $form->field($model, 'division')->textInput(['maxlength' => true, 'placeholder' => 'Division Name']) ?>
