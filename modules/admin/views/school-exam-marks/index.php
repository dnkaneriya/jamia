...
//function for change pagination 
    ...
    function submitForm()
    {
        ...
        if (strvalue != "") {
            document.getElementById('delete').href = '<?php echo Yii::$app->request->baseUrl; ?>/admin/school-exam-marks/change?str=' + strvalue + '&&field=is_deleted&&val=Y';
        } else {
        ...
        <div class="box">
            ...
            <div class="row p-a">
                ...
                <div class="col-sm-3 text-right">
                    <a href="<?= Yii::$app->request->baseurl ?>/admin/school-exam-marks/create" id="job-export" class="btn btn-fw primary" title="Create a class"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function($model) {
                            $class = Classes::findOne(['id' => $model->class_id]);
                            return (isset($class->name) && $class->name != '') ? $class->name : '';
                        }
                    ...
                    [
                        ...
                        'label' => 'SubClass',
                        'value' => function($model) {
                            $subclass = Subclass::findOne(['id' => $model->subclass_id]);
                            return (isset($subclass->sub_class) && $subclass->sub_class != '') ? $subclass->sub_class : '';
                        }
                    ...
                    [
                        ...
                        'label' => 'Semester',
                        'value' => function($model) {
                            $semester = SchoolExamSemester::findOne(['id' => $model->semester_id]);
                            return (isset($semester->semester) && $semester->semester != '') ? $semester->semester : '';
                        }
                     ...
                     [
                        ...
                        'label' => 'Subject',
                        'value' => function($model) {
                            $subject = SchoolSubject::findOne(['id' => $model->subject_id]);
                            return (isset($subject->name_en) && $subject->name_en != '') ? $subject->name_en : '';
                        }
                    ],     
                    [
                        'width' => '20%',
                        ...
                        'urlCreator' => function ($action, $model, $key, $index) {
                            if ($action === 'view') {
                                $url = Yii::$app->request->baseUrl . '/admin/school-exam-marks/view?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'update') {
                                $url = Yii::$app->request->baseUrl . '/admin/school-exam-marks/update?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'delete') {
