        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 text-center">Para Number</label>
                    <label class="col-sm-2 text-center">Line Number</label>
                </div>
                <?php
                ...
                <div class="col-sm-2">
                    <?= $form->field($model, 'para_no[]')->textInput(['type' => 'number', 'value' => $detArr['para_no'][$i]]) ?>
                    
                </div>
                <div class="col-sm-2">
                    <?= $form->field($model, 'line_no[]')->textInput(['type' => 'number', 'value' => $detArr['line_no'][$i]]) ?>
                </div>
