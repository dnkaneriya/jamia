        ...
        <div class="box">
            ...
            <div class="row p-a">
                ...
                <div class="col-sm-3 text-right">
                    <a href="<?= Yii::$app->request->baseurl ?>/admin/tajwid-marks/create" id="job-export" class="btn btn-fw primary" title="Create a class"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
...
//                        'filter' => $studentList,
                    ...
                    [
                        ...
                        'headerOptions' => ['style' => 'text-align:center'],
                        'pageSummary' => false,
                        'filter' => $tajwidSubjectList,
                        'value' => function($model) {
                            $className = TajwidSubject::find()->where(['id' => $model->subject_id])->one();
                            if ($className) {
                                return $className->subject_name;
                            } else {
                                return '';
                            }
                        }
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            if ($action === 'view') {
                                $url = Yii::$app->request->baseUrl . '/admin/tajwid-marks/view?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'update') {
                                $url = Yii::$app->request->baseUrl . '/admin/tajwid-marks/update?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'delete') {
