...
if(!$model->isNewRecord)
	$model->event_date = date('d-m-Y',$model->event_date);
?>
    ...
    <div class="col-lg-12">
		<!--<section class="panel">-->
            <div class="box-header">
				<?php
					if($model->isNewRecord) {
						echo '<h3>'.Yii::t('app', 'Add Event').'</h3>';
					}else{
						echo '<h3>'.Yii::t('app', 'Edit Event').'</h3>';
					}
				?>
            </div>
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'chief_guest')->textInput(['maxlength' => 255]); ?>

                <?= $form->field($model, 'event_date')->textInput(['maxlength' => 255,'id'=>'event_date']); ?>
