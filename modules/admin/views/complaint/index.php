...
$this->title = Yii::$app->params['apptitle'].' : Complaint List';
		...
		<div class="box">
			...
			<div class="row p-a">
			  ...
			  <div class="col-sm-3 text-right">
                              <a href="<?=Yii::$app->request->baseurl?>/admin/complaint/create" id="job-export" class="btn btn-fw primary" title="Create a class"><i class="fa fa-plus"></i> Add New</a>
			  </div>
			</div>
					...
					'columns' => [
						...
						[
                            ...
                            'value'=>function($model){
                                return date('d M Y', strtotime($model->c_date));
                            }
                        ],
                        [
                            'width'=>'50%',
