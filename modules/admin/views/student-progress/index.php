        ...
        <div class="box">
            ...
            <div class="row p-a">
                ...
                <div class="col-sm-3 text-right">
                    <a href="<?= Yii::$app->request->baseurl ?>/admin/student-progress/create" id="job-export" class="btn btn-fw primary" title="Create a class"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
            ...
            echo GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'label' => 'Category',
                        'value' => function($model) {
                            return ($model->category == 1) ? 'Islamic' : 'School';
                        }
                    ...
                    [
                        ...
                        'value' => function($model) {
                            $subject_name = '';
                            if($model->category == 1) {
                                $subjects = app\models\Subject::findAll(['is_active' => 'Y', 'is_deleted' => 'N']);
                                if(!empty($subjects) && count($subjects) > 0) {
                                    //$subject_name = $subjects->name_en;
                                }
                            } else if($model->category == 2) {
                                $subjects = \app\models\SchoolSubject::findAll(['is_active' => 'Y', 'is_deleted' => 'N']);
                                if(!empty($subjects) && count($subjects) > 0) {
                                    $subject_name = $subjects->name_en;
                                }
                            }
                    ...
                    [
                        ...
                        'urlCreator' => function ($action, $model, $key, $index) {
                            if ($action === 'view') {
                                $url = Yii::$app->request->baseUrl . '/admin/student-progress/view?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'update') {
                                $url = Yii::$app->request->baseUrl . '/admin/student-progress/update?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'delete') {
