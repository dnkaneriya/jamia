...
$this->title = Yii::$app->params['apptitle'] . ' : Tarbiyat Subject';
...
//function for change pagination 
    ...
    function submitForm()
    {
        ...
        if (strvalue != "") {
            ...
            document.getElementById('delete').href = '<?php echo Yii::$app->request->baseUrl; ?>/admin/tarbiyatsubject/change?str=' + strvalue + '&&field=is_deleted&&val=Y';
        } else {
        ...
        <div class="box">
            ...
            <div class="row p-a">
                ...
                <div class="col-sm-3 text-right">
                    <a href="<?= Yii::$app->request->baseurl ?>/admin/tarbiyatsubject/create" id="job-export" class="btn btn-fw primary" title="Create a class"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
<?php \yii\widgets\Pjax::begin(['linkSelector' => '', 'id' => 'w0-pjax']); ?>	
            ...
            echo GridView::widget([
                ...
                'layout' => $layout,
                'captionOptions' => ['title' => 'Tarbiyat Subject'],
                'columns' => [
                        [
                    ...
                    /* [
                      ...
                      return $btn;
                        ...
                        'urlCreator' => function ($action, $model, $key, $index) {
                            if ($action === 'view') {
                                $url = Yii::$app->request->baseUrl . '/admin/tarbiyatsubject/view?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'update') {
                                $url = Yii::$app->request->baseUrl . '/admin/tarbiyatsubject/update?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'delete') {
