    ...
    <div class="col-lg-12">
		<!--<section class="panel">-->
            <div class="box-header">
				<?php
					if($model->isNewRecord) {
						echo '<h3>'.Yii::t('app', 'Add Class').'</h3>';
					}else{
						echo '<h3>'.Yii::t('app', 'Edit Class').'</h3>';
					}
				?>
            </div>
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => 'Class Name']) ?>
