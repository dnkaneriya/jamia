    ...
    <div class="col-lg-12">
		<!--<section class="panel">-->
            <div class="box-header">
				<?php
					if($model->isNewRecord) {
						echo '<h3>'.Yii::t('app', 'Add Contact No.').'</h3>';
					}else{
						echo '<h3>'.Yii::t('app', 'Edit Contact No.').'</h3>';
					}
				?>
            </div>
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'address')->textArea(['rows' => 6, 'placeholder' => 'Address']) ?>
                ...
                <?= $form->field($model, 'landline')->textInput(['maxlength' => true, 'placeholder' => 'Landline']) ?>
