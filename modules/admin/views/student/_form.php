        ...
        <div class="box-body">
            ...
            <div class="form-group field-register_status">
                <div class="row">
                    ...
                    <?php if (isset($model->register_status) && $model->register_status == 'N') {
                        $new = 'checked="checked"';
                        $old = '';
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <select name="Student[how_old]" class="form-control student-how_old" id="student-how_old">
                                ...
                                <option value="1" <?php if ($model->how_old == '1') {
                        echo 'selected="selected"';
                    } ?>>Old By 1 Year</option>
                                <option value="2" <?php if ($model->how_old == '2') {
                echo 'selected="selected"';
            } ?>>Old By 2 Year</option>
                                <option value="3" <?php if ($model->how_old == '3') {
                echo 'selected="selected"';
            } ?>>Old By 3 Year</option>
                                <option value="4" <?php if ($model->how_old == '4') {
                echo 'selected="selected"';
            } ?>>Old By 4 Year</option>
                            </select>
                            <div class="help-block help-block-error "></div>
                        </div>
                    </div>
...
<?php for ($i = 1; $i <= 31; $i++) {
    ...
    <?php if (!$model->isNewRecord && $date == $i) {
...
<?php for ($i = 1; $i <= 12; $i++) {
    ...
    <?php if (!$model->isNewRecord && $month == $i) {
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <select name="Student[bloodgroup]" class="form-control" id="student-bloodgroup">
                            ...
                            <option value="A+" <?php if ($model->bloodgroup == 'A+') {
    echo 'selected="selected"';
} ?>>A+</option>
                            <option value="A-" <?php if ($model->bloodgroup == 'A-') {
                echo 'selected="selected"';
            } ?>>A-</option>
                            <option value="B+" <?php if ($model->bloodgroup == 'B+') {
                echo 'selected="selected"';
            } ?>>B+</option>
                            <option value="B-" <?php if ($model->bloodgroup == 'B-') {
                echo 'selected="selected"';
            } ?>>B-</option>
                            <option value="AB+" <?php if ($model->bloodgroup == 'AB+') {
                echo 'selected="selected"';
            } ?>>AB+</option>
                            <option value="AB-" <?php if ($model->bloodgroup == 'AB-') {
                echo 'selected="selected"';
            } ?>>AB-</option>
                            <option value="O+" <?php if ($model->bloodgroup == 'O+') {
                echo 'selected="selected"';
            } ?>>O+</option>
                            <option value="O-" <?php if ($model->bloodgroup == 'O-') {
                echo 'selected="selected"';
...
<?= $form->field($model, 'pincode')->textInput(['maxlength' => true, 'placeholder' => 'Pincode']) ?>
            ...
            <div class="form-group field-studenteducation-madrasa_name">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="Studenteducation[madrasa_name]" <?php if (!$model->isNewRecord && $education != array()) { ?> value="<?= $education->madrasa_name ?>" <?php } ?> class="form-control" id="studenteducation-madrasa_name">
                        <div class="help-block help-block-error "></div>
                    </div>
                </div>
            </div>
            <div class="form-group field-studenteducation-nazra">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="checkbox" class="has-value" id="Studenteducation-nazra" name="Studenteducation[nazra]" value="1" <?php if (!$model->isNewRecord && $education != array() && $education->nazra == 'Y') {
    echo 'checked="checked"';
    $nazra_display = 'style="display:block;"';
} else {
    $nazra_display = 'style="display:none;"';
} ?>>
                        <div class="help-block help-block-error "></div>
                    </div>
                </div>
...
<?php for ($i = 1; $i <= 30; $i++) {
    ...
    <?php if (!$model->isNewRecord && $education != array() && $education->nazra_para == $i) {
        $nazra_selected = 'selected="selected"';
    } else {
        $nazra_selected = '';
    } ?>
            ...
            <div class="form-group field-studenteducation-hifz">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="checkbox" class="has-value" id="Studenteducation-hifz" name="Studenteducation[hifz]" value="1" <?php if (!$model->isNewRecord && $education != array() && $education->hifz == 'Y') {
    echo 'checked="checked"';
    $hifz_display = 'style="display:block;"';
} else {
    $hifz_display = 'style="display:none;"';
} ?>>
                    </div>
                </div>
            </div>
            ...
            <?php for ($i = 1; $i <= 30; $i++) {
                ...
                <?php if (!$model->isNewRecord && $education != array() && $education->hifz_para == $i) {
                    $hifz_selected = 'selected="selected"';
                } else {
                    $hifz_selected = '';
                } ?>
            ...
            <div class="form-group field-studenteducation-urdu">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="checkbox" class="has-value" id="Studenteducation-urdu" name="Studenteducation[urdu]" value="1" <?php if (!$model->isNewRecord && $education != array() && $education->urdu == 'Y') {
                echo 'checked="checked"';
            } ?>>
                    </div>
                </div>
            ...
            <div class="form-group field-studenteducation-arabic">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="checkbox" class="has-value" id="Studenteducation-arabic" name="Studenteducation[arabic]" value="1" <?php if (!$model->isNewRecord && $education != array() && $education->arabic == 'Y') {
                echo 'checked="checked"';
            } ?>>
                    </div>
                </div>
            ...
            <div class="form-group field-studenteducation-school_name">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="Studenteducation[school_name]" <?php if (!$model->isNewRecord && $education != array()) { ?> value="<?= $education->school_name ?>" <?php } ?> class="form-control" id="studenteducation-school_name">
                        <div class="help-block help-block-error "></div>
                    </div>
                </div>
            </div>
            <div class="form-group field-studenteducation-school_standard">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="Studenteducation[school_standard]" <?php if (!$model->isNewRecord && $education != array()) { ?> value="<?= $education->school_standard ?>" <?php } ?> class="form-control" id="studenteducation-school_standard">
                        <div class="help-block help-block-error "></div>
                    </div>
                </div>
            </div>
...
<?php if ($model->isNewRecord) {
    ...
    $eng = '';
                        ...
                        <label class="md-check form-control-label">
                            <input type="radio" id="school_medium_urdu" class="has-value" name="Studenteducation[school_medium]" value="U" <?php if (!$model->isNewRecord && $education != array() && $education->school_medium == 'U') {
    echo 'checked="checked"';
} ?>> Urdu
                            <i class="blue"></i>
                        </label>
                        <label class="md-check form-control-label">
                            <input type="radio" id="school_medium_english" class="has-value" name="Studenteducation[school_medium]" value="E" <?php if (!$model->isNewRecord && $education != array() && $education->school_medium == 'E') {
    echo 'checked="checked"';
} ?> <?= $eng ?>> English
                            <i class="blue"></i>
                        </label>
                        <label class="md-check form-control-label">
                            <input type="radio" id="school_medium_hindi" class="has-value" name="Studenteducation[school_medium]" value="H" <?php if (!$model->isNewRecord && $education != array() && $education->school_medium == 'H') {
    echo 'checked="checked"';
} ?>> Hindi
                            <i class="blue"></i>
                        </label>
                        <label class="md-check form-control-label">
                            <input type="radio" id="school_medium_other" class="has-value" name="Studenteducation[school_medium]" value="O" <?php if (!$model->isNewRecord && $education != array() && $education->school_medium == 'O') {
    echo 'checked="checked"';
} ?>> Other
                            <i class="blue"></i>
                        </label>
            ...
            <div class="form-group field-studenteducation-grade">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="Studenteducation[grade]" <?php if (!$model->isNewRecord && $education != array()) { ?> value="<?= $education->grade ?>" <?php } ?> class="form-control" id="studenteducation-grade">
                        <div class="help-block help-block-error "></div>
                    </div>
                </div>
            </div>
...
?>
<?= $form->field($model, 'class_id')->dropDownList($clistData, 
        [
            'prompt' => '-Select Class-',
            'onchange' => '
                $( "select#student-sub_class_id" ).html("showLoading");
                $.post( "'. Yii::$app->urlManager->createAbsoluteUrl('admin/mark/get-subclass-list') .'?id=' . '"+$(this).val(), 
                function(data) {
                        $( "select#student-sub_class_id" ).html(data);
                });'
        ]); ?>
<?= $form->field($model, 'sub_class_id')->dropDownList($slistData, 
        [
            'prompt' => '-Select Sub Class-',
            'onchange' => '
                $( "select#student-divison_id" ).html("showLoading");
                $.post( "' . Yii::$app->urlManager->createAbsoluteUrl('admin/mark/get-division-list') . '?class_id=' . '"+$("#student-class_id").val()+"&subclass_id="+$(this).val(), 
                function(data) {
                        $( "select#student-divison_id" ).html(data);
                });'
        ]); ?>
...
<script type="text/javascript">
    ...
    form1.validate({
        ...
        rules: {
            ...
            "Studenteducation[school_standard]": {
                digits: true,
            },
            "Student[class_id]": {
                required: true
