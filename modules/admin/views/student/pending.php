...
function select_student()
{
   var strvalue = "";
    ...
    if(strvalue!=""){
        document.getElementById('student_select').href = '<?php echo Yii::$app->request->baseUrl;?>/admin/student/selectedstudent?str='+strvalue;
    }
}
...
function exportcsv()
{
   ...
   document.getElementById('student-export').href = '<?php echo Yii::$app->request->baseUrl;?>/admin/student/export?str='+strvalue+'&&redirect=pending'; 
}
		...
		<div class="box">
			...
			<div class="row p-a">
			  ...
			  <div class="col-sm-5 text-right">
                <a href="javascript:void(0);" class="btn btn-fw primary" onclick="select_student();" id="student_select">Select</a>
			...
			<?php $layout = '<div class="btn-group pull-right">{toolbar}</div><div class="clearfix"></div>{items}<div class="text-right">{pager}</div>';
					...
					'columns' => [
						...
						[
                            ...
                            'headerOptions' => ['style' => 'text-align:center'],
                            'template' => '{update}&nbsp;{delete}&nbsp{view}', //{view}&nbsp;
                            'buttons' => [
