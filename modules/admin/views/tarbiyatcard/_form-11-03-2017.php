...
<?php echo Yii::t('app', 'You have some form errors. Please check below'); ?>
            ...
            ?>
            <?= $form->field($model, 'student_id')->dropDownList($studentData, ['prompt' => '-Select Student-']); ?>
            <div class="form-group field-date">
                <div class="row">
                    <label class="control-label col-sm-2 form-control-label" for="tarbiyatcard-t_year">Year</label>
                    <div class="col-lg-4">
                        <select name="Tarbiyatcard[t_year]" class="form-control" id="tarbiyatcard-t_year">
