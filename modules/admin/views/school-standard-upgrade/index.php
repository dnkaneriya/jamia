        ...
        <div class="box">
            ...
            <div class="row p-a">
                ...
                <div class="col-sm-3 text-right">
                    <a href="<?= Yii::$app->request->baseurl ?>/admin/school-standard-upgrade/create" id="job-export" class="btn btn-fw primary" title="Create a class"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
            ...
            echo GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'filter' => $standardList,
                        'value' => function($model) {
                            $standard = SchoolExam::findOne(['id' => $model->upgrade_standard_id]);
                            if(!empty($standard) && count($standard) > 0) {
                                return $standard->standard;
                            } else {
                                return '';
