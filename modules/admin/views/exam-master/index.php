...
$this->title = Yii::t('app', 'Exam Master');
        ...
        <div class="box">
            ...
            <div class="row p-a">
              ...
              <div class="col-sm-3 text-right">
                ...
                <a href="<?=Yii::$app->request->baseurl?>/admin/exam-master/create" id="job-export" class="btn btn-fw primary" title="Add New Exam"><i class="fa fa-plus"></i> Add New</a> 
              </div>
            </div>
            ...
            <?php $layout = '<div class="btn-group pull-right">{toolbar}</div><div class="clearfix"></div>{items}<div class="text-right">{pager}</div>';
                    ...
                    'layout' => $layout,
                    'captionOptions'=>['title'=>'Exam List'],
                    'columns' => [
                        [
                        ...
                        [
                            ...
                            'urlCreator' => function ($action, $model, $key, $index) {
                                if ($action === 'view') {
                                        $url =Yii::$app->request->baseUrl.'/admin/exam-master/view?id='.$model->id;
                                        return $url;
                                }
                                if ($action === 'update') {
                                        $url = Yii::$app->request->baseUrl.'/admin/exam-master/update?id='.$model->id;
                                        return $url;
                                }
                                if ($action === 'delete') {
