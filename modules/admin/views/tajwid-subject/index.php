...
$this->title = Yii::$app->params['apptitle'] . ' : Tajwadi Subject List';
...
//function for change pagination 
    ...
    function submitForm()
    {
        ...
        if (strvalue != "") {
            ...
            document.getElementById('delete').href = '<?php echo Yii::$app->request->baseUrl; ?>/admin/classes/change?str=' + strvalue + '&&field=is_deleted&&val=Y';
        } else {
        ...
        <div class="box">
            ...
            <div class="row p-a">
                ...
                <div class="col-sm-3 text-right">
                    <a href="<?= Yii::$app->request->baseurl ?>/admin/tajwid-subject/create" id="job-export" class="btn btn-fw primary" title="Create a class"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
            ...
            echo GridView::widget([
                ...
                'layout' => $layout,
                'captionOptions' => ['title' => 'Class List'],
                'columns' => [
                    [
...
//                        'filter' => $tajwidClassList,
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            if ($action === 'view') {
                                $url = Yii::$app->request->baseUrl . '/admin/tajwid-subject/view?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'update') {
                                $url = Yii::$app->request->baseUrl . '/admin/tajwid-subject/update?id=' . $model->id;
                                return $url;
                            }
                            if ($action === 'delete') {
