    ...
    <div class="col-lg-12">
        ...
        <div class="box-header">
            ...
            if ($model->isNewRecord) {
                echo '<h3>' . Yii::t('app', 'Add Hostel Information') . '</h3>';
            } else {
                echo '<h3>' . Yii::t('app', 'Edit Hostel Information') . '</h3>';
            }
            ?>
        </div>
        ...
        <div class="box-body">
            ...
            <?= $form->field($model, 'student_id')->dropDownList($studentList, ['prompt' => '-Select Gr No-']); ?>
            <?= $form->field($model, 'room_id')->dropDownList($roomList, ['prompt' => '-Select Room-', 'class' => 'form-control changeroom']); ?>
            <div class="dispbed"></div>
            <?= $form->field($model, 'is_monitor')->checkbox() ?>
...
<?php if (!$model->isNewRecord) { ?>
        callbed($(".changeroom option:selected").val(),<?= $model->bed_id ?>);
<?php } ?>
    function callbed(room, bed) {
        $.ajax({type: "GET",
            url: "getbed",
            data: {room: room, bed: bed},
