    ...
    <div class="col-lg-12">
		<!--<section class="panel">-->
            <div class="box-header">
				<?php
					if($model->isNewRecord) {
						echo '<h3>'.Yii::t('app', 'Add Bed').'</h3>';
					}else{
						echo '<h3>'.Yii::t('app', 'Edit Bed').'</h3>';
					}
				?>
            </div>
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'room_id')->dropDownList($roomlist, ['prompt' => '-Select Room-']); ?>
                <?= $form->field($model, 'bed_no')->textInput(['maxlength' => 255]); ?>
