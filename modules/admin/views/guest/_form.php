...
$model->out_date = date('d-m-Y',$model->out_date);
$model->in_date = date('d-m-Y',$model->in_date);
}
?>
    ...
    <div class="col-lg-12">
		<!--<section class="panel">-->
            <div class="box-header">
				<?php
					if($model->isNewRecord) {
						echo '<h3>'.Yii::t('app', 'Add Guest').'</h3>';
					}else{
						echo '<h3>'.Yii::t('app', 'Edit Guest').'</h3>';
					}
				?>
            </div>
            ...
            <div class="box-body">
                ...
                <?= $form->field($model, 'in_date')->textInput(['maxlength' => 255,'id'=>'in_date']); ?>
                <?= $form->field($model, 'out_date')->textInput(['maxlength' => 255,'id'=>'out_date']); ?>
...
<script type="text/javascript">
	...
	$(function() {
			$( "#in_date" ).datepicker({
				...
				$('#out_date').datepicker('setStartDate', startDate);
			});
		});
			...
			$(function() {
				$( "#out_date" ).datepicker({
				  ...
				  $('#in_date').datepicker('setEndDate', endDate);
			  });
		});		
	
    var form1 = $('#guest-form');
