            ...
            <tr>
             <td style="font-family:Helvetica,Arial,sans-serif">
              ...
              <table border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif" width="100%" bgcolor="#DDDDDD">
               <tbody>
                <tr>
                 <td align="left" valign="middle" width="95" height="21"><a style="text-decoration:none;border:none;display:block;min-height:21px;width:100%" href="<?=Url::to('@web',true)?>" target="_blank">
                 <img src="<?=Url::to('@web/'."img/logo.png",true) ?>" width="95" height="21" alt="LinkedIn" style="border:none;text-decoration:none">
                 </a></td>
                </tr>
               </tbody>
              </table>
                ...
                <tr>
                 ...
                 <td style="color:#333333;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:18px" align="left">
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif" width="100%">
                   <tbody>
                    <tr>
                     <td style="font-family:Helvetica,Arial,sans-serif;color:#333333"> Dear <b>User</b>, Welcome to crossfit. </td>
                    </tr>
                    <tr>
                        ...
                        <tr>
                         <td>
                          <table border="0" cellpadding="0" cellspacing="0" align="left">
                           <tbody>
                            <tr>
                             <td align="center" height="30" valign="middle" bgcolor="#287BBC" style="background-color:#287bbc;border:1px solid #1b5480;border-radius:3px">
                              <table border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif" width="100%" bgcolor="transparent">
                               <tbody>
                                <tr>
                                 <td width="13">
                                 <td><a style="text-decoration:none;font-size:13px;font-weight:bold;color:white;white-space:nowrap;display:block" target="_blank">
                                       <span style="font-size:13px;font-weight:bold;color:white;white-space:nowrap;display:block">
                                          Confirm you know HR
                                       </span>
                                     </a>
                                 </td>
