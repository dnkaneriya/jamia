    ...
    <div class="modal-dialog">
		<div class="modal-content box-shadow-md m-b">
			...
			<div class="modal-body">
                ...
                <?= $form->field($user, 'email',['inputOptions'=>array('placeholder'=>'Email ID','autocomplete'=>"off",'class'=>"form-control placeholder-no-fix")])->label(false); ?>    
            </div>
