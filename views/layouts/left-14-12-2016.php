            ...
            <nav class="scroll nav-light">
                <ul class="nav" ui-nav>
                        ...
                        <ul class="nav-sub">
                           ...
                           <li>
                               <a>
                                ...
                                <ul class="nav-sub">
                                    <li class="<?=activeness(['classes', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Semester</span>',["/admin/school-exam-semester/index"], ["class"=>"classes"]) ?>
                                    </li>
                                </ul>
                           </li>
                        </ul>
                    ...
                    <li class="<?=activeness(['classes', 'index'])?>">
                        ...
                        <ul class="nav-sub">
                           <li>
                                ...
                                <ul class="nav-sub">
                                    <li class="<?=activeness(['classes', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Exam Master</span>',["/admin/exam-master/index"], ["class"=>"classes"]) ?>
                                    </li>
                                    <li class="<?=activeness(['classes', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Mark</span>',["/admin/mark/index"], ["class"=>"classes"]) ?>
                                    </li>
                                    <li class="<?=activeness(['subclass', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Result</span>',["/admin/result-master/index"], ["class"=>"classes"]) ?>
                                    </li>
                                    <li class="<?=activeness(['subject', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Subject</span>',["/admin/subject/index"], ["class"=>"classes"]) ?>
                                    </li>
                                    <li class="<?=activeness(['class-upgrade-master', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Class Upgrade</span>',["/admin/class-upgrade-master/index"], ["class"=>"classes"]) ?>
                                    </li>
                                </ul>   
                           </li>
                           <li>
                               <a>
                                ...
                                <ul class="nav-sub">
                                    <li class="<?=activeness(['classes', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Mark</span>',["/admin/tajwid-marks/index"], ["class"=>"classes"]) ?>
                                    </li>
                                    <li class="<?=activeness(['subclass', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Result</span>',["/admin/tajwid-result/index"], ["class"=>"classes"]) ?>
                                    </li>
                                    <li class="<?=activeness(['subclass', 'index'])?>">
                           ...
                           <li>
                               <a>
                                ...
                                <ul class="nav-sub">
                                    <li class="<?=activeness(['classes', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Mark</span>',["/admin/school-exam-marks/index"], ["class"=>"classes"]) ?>
                                    </li>
                                    <li class="<?=activeness(['subclass', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Result</span>',["#"], ["class"=>"classes"]) ?>
                                    </li>
                                    <li class="<?=activeness(['subject', 'index'])?>">
                                        <?= Html::a('<span class="nav-text">Subject</span>',["/admin/school-subject/index"], ["class"=>"classes"]) ?>
                                    </li>
                                </ul>
                           </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="nav-sub">
                            <li><?= Html::a('<span class="nav-text">Class Result</span>',["/admin/report/class-result"], ["class"=>"nav-link"]) ?></li>
                            <li><?= Html::a('<span class="nav-text">Hostel Report</span>',["/admin/report/hostel-room-report"], ["class"=>"nav-link"]) ?></li>
                        </ul>
                    </li>
                </ul>
            </nav>
