        ...
        <div flex class="hide-scroll">
            <nav class="scroll nav-light">
                <ul class="nav" ui-nav>
                    ...
                    */ ?>
                    <li>
                        <?= Html::a('<span class="nav-icon"><i class="material-icons">&#xe7ef;</i></span><span class="nav-text">Contact Detail</span>',["/admin/contactdetail/update?id=1"], ["class"=>"nav-link"]) ?>
                    </li>
                    <li>
                        <?= Html::a('<span class="nav-icon"><i class="material-icons">&#xe7ef;</i></span><span class="nav-text">CMS Pages</span>',["/admin/cms/index"], ["class"=>"nav-link"]) ?>
                    </li>
                    <li>
                        <?= Html::a('<span class="nav-icon"><i class="material-icons">&#xe7ef;</i></span><span class="nav-text">Home Banners</span>',["/admin/homebanners/index"], ["class"=>"nav-link"]) ?>
                    </li>
                    <li>
