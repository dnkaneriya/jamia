...
/**
 * HomebannersSearch represents the model behind the search form about `app\models\Homebanners`.
 */
class HomebannersSearch extends Homebanners
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['banner', 'is_active', 'is_deleted'], 'safe'],
        ];
    }
